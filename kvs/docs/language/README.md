...
KVS is an experimental TypeScript dialect that gives application logic itself a more prominent place
in the code. It builds on TypeScript’s static type system and is designed to transpile into ordinary
JavaScript.
...
- [Postponed Changes](postponed.md) — accepted directions deliberately deferred because their
  compatibility or implementation cost is outside the current slice.
