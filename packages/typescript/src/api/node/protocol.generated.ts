...
export const childProperties: Readonly<Partial<Record<SyntaxKind, readonly (string | undefined)[]>>> = {
    ...
    [SyntaxKind.KvsExtantReturnStatement]: ["expression"],
    [SyntaxKind.KvsYieldStatement]: ["expression"],
    [SyntaxKind.KvsExtantYieldStatement]: ["expression"],
    [SyntaxKind.KvsIfBindingStatement]: ["clause", "elseStatement"],
    [SyntaxKind.KvsIfBindingClause]: ["declarationList", "statement"],
    ...
    [SyntaxKind.KvsFailurePromotionExpression]: ["expression", "firstTildeToken", "secondTildeToken", "replacement"],
    [SyntaxKind.KvsCatchSplitExpression]: ["expression"],
    [SyntaxKind.KvsCatchSplitAssignmentExpression]: ["valueTarget", "tildeToken", "errorTarget", "equalsToken", "expression"],
    [SyntaxKind.KvsComparisonAlternativesExpression]: ["subject", "operatorToken", "spreadToken", "alternatives"],
    [SyntaxKind.KvsComparisonChainExpression]: ["operands", "operators"],
    ...
    [SyntaxKind.KvsCatchSplitBindingPattern]: ["elements"],
    ...
    [SyntaxKind.KvsNullableType]: ["type", "questionToken"],
    [SyntaxKind.KvsExtantType]: ["type", "exclamationToken"],
