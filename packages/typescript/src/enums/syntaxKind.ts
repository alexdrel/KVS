...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["SpreadElement"] = 244] = "SpreadElement";
    SyntaxKind[SyntaxKind["ClassExpression"] = 245] = "ClassExpression";
    SyntaxKind[SyntaxKind["OmittedExpression"] = 246] = "OmittedExpression";
    SyntaxKind[SyntaxKind["ExpressionWithTypeArguments"] = 247] = "ExpressionWithTypeArguments";
    SyntaxKind[SyntaxKind["AsExpression"] = 248] = "AsExpression";
    SyntaxKind[SyntaxKind["NonNullExpression"] = 249] = "NonNullExpression";
    SyntaxKind[SyntaxKind["MetaProperty"] = 250] = "MetaProperty";
    SyntaxKind[SyntaxKind["SyntheticExpression"] = 251] = "SyntheticExpression";
    SyntaxKind[SyntaxKind["SatisfiesExpression"] = 252] = "SatisfiesExpression";
    SyntaxKind[SyntaxKind["TemplateSpan"] = 253] = "TemplateSpan";
    SyntaxKind[SyntaxKind["SemicolonClassElement"] = 254] = "SemicolonClassElement";
    SyntaxKind[SyntaxKind["Block"] = 255] = "Block";
    SyntaxKind[SyntaxKind["EmptyStatement"] = 256] = "EmptyStatement";
    SyntaxKind[SyntaxKind["VariableStatement"] = 257] = "VariableStatement";
    SyntaxKind[SyntaxKind["ExpressionStatement"] = 258] = "ExpressionStatement";
    SyntaxKind[SyntaxKind["IfStatement"] = 259] = "IfStatement";
    SyntaxKind[SyntaxKind["DoStatement"] = 260] = "DoStatement";
    SyntaxKind[SyntaxKind["WhileStatement"] = 261] = "WhileStatement";
    SyntaxKind[SyntaxKind["ForStatement"] = 262] = "ForStatement";
    SyntaxKind[SyntaxKind["ForInStatement"] = 263] = "ForInStatement";
    SyntaxKind[SyntaxKind["ForOfStatement"] = 264] = "ForOfStatement";
    SyntaxKind[SyntaxKind["ContinueStatement"] = 265] = "ContinueStatement";
    SyntaxKind[SyntaxKind["BreakStatement"] = 266] = "BreakStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 267] = "ReturnStatement";
    SyntaxKind[SyntaxKind["WithStatement"] = 268] = "WithStatement";
    SyntaxKind[SyntaxKind["SwitchStatement"] = 269] = "SwitchStatement";
    SyntaxKind[SyntaxKind["LabeledStatement"] = 270] = "LabeledStatement";
    SyntaxKind[SyntaxKind["ThrowStatement"] = 271] = "ThrowStatement";
    SyntaxKind[SyntaxKind["TryStatement"] = 272] = "TryStatement";
    SyntaxKind[SyntaxKind["DebuggerStatement"] = 273] = "DebuggerStatement";
    SyntaxKind[SyntaxKind["KvsExtantReturnStatement"] = 274] = "KvsExtantReturnStatement";
    SyntaxKind[SyntaxKind["KvsYieldStatement"] = 275] = "KvsYieldStatement";
    SyntaxKind[SyntaxKind["KvsExtantYieldStatement"] = 276] = "KvsExtantYieldStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingStatement"] = 277] = "KvsIfBindingStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingClause"] = 278] = "KvsIfBindingClause";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 279] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["VariableDeclarationList"] = 280] = "VariableDeclarationList";
    SyntaxKind[SyntaxKind["FunctionDeclaration"] = 281] = "FunctionDeclaration";
    SyntaxKind[SyntaxKind["ClassDeclaration"] = 282] = "ClassDeclaration";
    SyntaxKind[SyntaxKind["InterfaceDeclaration"] = 283] = "InterfaceDeclaration";
    SyntaxKind[SyntaxKind["TypeAliasDeclaration"] = 284] = "TypeAliasDeclaration";
    SyntaxKind[SyntaxKind["EnumDeclaration"] = 285] = "EnumDeclaration";
    SyntaxKind[SyntaxKind["ModuleDeclaration"] = 286] = "ModuleDeclaration";
    SyntaxKind[SyntaxKind["ModuleBlock"] = 287] = "ModuleBlock";
    SyntaxKind[SyntaxKind["CaseBlock"] = 288] = "CaseBlock";
    SyntaxKind[SyntaxKind["NamespaceExportDeclaration"] = 289] = "NamespaceExportDeclaration";
    SyntaxKind[SyntaxKind["ImportEqualsDeclaration"] = 290] = "ImportEqualsDeclaration";
    SyntaxKind[SyntaxKind["ImportDeclaration"] = 291] = "ImportDeclaration";
    SyntaxKind[SyntaxKind["ImportClause"] = 292] = "ImportClause";
    SyntaxKind[SyntaxKind["NamespaceImport"] = 293] = "NamespaceImport";
    SyntaxKind[SyntaxKind["NamedImports"] = 294] = "NamedImports";
    SyntaxKind[SyntaxKind["ImportSpecifier"] = 295] = "ImportSpecifier";
    SyntaxKind[SyntaxKind["ExportAssignment"] = 296] = "ExportAssignment";
    SyntaxKind[SyntaxKind["ExportDeclaration"] = 297] = "ExportDeclaration";
    SyntaxKind[SyntaxKind["NamedExports"] = 298] = "NamedExports";
    SyntaxKind[SyntaxKind["NamespaceExport"] = 299] = "NamespaceExport";
    SyntaxKind[SyntaxKind["ExportSpecifier"] = 300] = "ExportSpecifier";
    SyntaxKind[SyntaxKind["MissingDeclaration"] = 301] = "MissingDeclaration";
    SyntaxKind[SyntaxKind["ExternalModuleReference"] = 302] = "ExternalModuleReference";
    SyntaxKind[SyntaxKind["JsxElement"] = 303] = "JsxElement";
    SyntaxKind[SyntaxKind["JsxSelfClosingElement"] = 304] = "JsxSelfClosingElement";
    SyntaxKind[SyntaxKind["JsxOpeningElement"] = 305] = "JsxOpeningElement";
    SyntaxKind[SyntaxKind["JsxClosingElement"] = 306] = "JsxClosingElement";
    SyntaxKind[SyntaxKind["JsxFragment"] = 307] = "JsxFragment";
    SyntaxKind[SyntaxKind["JsxOpeningFragment"] = 308] = "JsxOpeningFragment";
    SyntaxKind[SyntaxKind["JsxClosingFragment"] = 309] = "JsxClosingFragment";
    SyntaxKind[SyntaxKind["JsxAttribute"] = 310] = "JsxAttribute";
    SyntaxKind[SyntaxKind["JsxAttributes"] = 311] = "JsxAttributes";
    SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 312] = "JsxSpreadAttribute";
    SyntaxKind[SyntaxKind["JsxExpression"] = 313] = "JsxExpression";
    SyntaxKind[SyntaxKind["JsxNamespacedName"] = 314] = "JsxNamespacedName";
    SyntaxKind[SyntaxKind["CaseClause"] = 315] = "CaseClause";
    SyntaxKind[SyntaxKind["DefaultClause"] = 316] = "DefaultClause";
    SyntaxKind[SyntaxKind["HeritageClause"] = 317] = "HeritageClause";
    SyntaxKind[SyntaxKind["CatchClause"] = 318] = "CatchClause";
    SyntaxKind[SyntaxKind["ImportAttributes"] = 319] = "ImportAttributes";
    SyntaxKind[SyntaxKind["ImportAttribute"] = 320] = "ImportAttribute";
    SyntaxKind[SyntaxKind["PropertyAssignment"] = 321] = "PropertyAssignment";
    SyntaxKind[SyntaxKind["ShorthandPropertyAssignment"] = 322] = "ShorthandPropertyAssignment";
    SyntaxKind[SyntaxKind["SpreadAssignment"] = 323] = "SpreadAssignment";
    SyntaxKind[SyntaxKind["EnumMember"] = 324] = "EnumMember";
    SyntaxKind[SyntaxKind["SourceFile"] = 325] = "SourceFile";
    SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 326] = "JSDocTypeExpression";
    SyntaxKind[SyntaxKind["JSDocNameReference"] = 327] = "JSDocNameReference";
    SyntaxKind[SyntaxKind["JSDocAllType"] = 328] = "JSDocAllType";
    SyntaxKind[SyntaxKind["JSDocNullableType"] = 329] = "JSDocNullableType";
    SyntaxKind[SyntaxKind["JSDocNonNullableType"] = 330] = "JSDocNonNullableType";
    SyntaxKind[SyntaxKind["JSDocOptionalType"] = 331] = "JSDocOptionalType";
    SyntaxKind[SyntaxKind["JSDocVariadicType"] = 332] = "JSDocVariadicType";
    SyntaxKind[SyntaxKind["JSDoc"] = 333] = "JSDoc";
    SyntaxKind[SyntaxKind["JSDocText"] = 334] = "JSDocText";
    SyntaxKind[SyntaxKind["JSDocTypeLiteral"] = 335] = "JSDocTypeLiteral";
    SyntaxKind[SyntaxKind["JSDocSignature"] = 336] = "JSDocSignature";
    SyntaxKind[SyntaxKind["JSDocLink"] = 337] = "JSDocLink";
    SyntaxKind[SyntaxKind["JSDocLinkCode"] = 338] = "JSDocLinkCode";
    SyntaxKind[SyntaxKind["JSDocLinkPlain"] = 339] = "JSDocLinkPlain";
    SyntaxKind[SyntaxKind["JSDocUnknownTag"] = 340] = "JSDocUnknownTag";
    SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 341] = "JSDocAugmentsTag";
    SyntaxKind[SyntaxKind["JSDocImplementsTag"] = 342] = "JSDocImplementsTag";
    SyntaxKind[SyntaxKind["JSDocDeprecatedTag"] = 343] = "JSDocDeprecatedTag";
    SyntaxKind[SyntaxKind["JSDocPublicTag"] = 344] = "JSDocPublicTag";
    SyntaxKind[SyntaxKind["JSDocPrivateTag"] = 345] = "JSDocPrivateTag";
    SyntaxKind[SyntaxKind["JSDocProtectedTag"] = 346] = "JSDocProtectedTag";
    SyntaxKind[SyntaxKind["JSDocReadonlyTag"] = 347] = "JSDocReadonlyTag";
    SyntaxKind[SyntaxKind["JSDocOverrideTag"] = 348] = "JSDocOverrideTag";
    SyntaxKind[SyntaxKind["JSDocCallbackTag"] = 349] = "JSDocCallbackTag";
    SyntaxKind[SyntaxKind["JSDocOverloadTag"] = 350] = "JSDocOverloadTag";
    SyntaxKind[SyntaxKind["JSDocParameterTag"] = 351] = "JSDocParameterTag";
    SyntaxKind[SyntaxKind["JSDocReturnTag"] = 352] = "JSDocReturnTag";
    SyntaxKind[SyntaxKind["JSDocThisTag"] = 353] = "JSDocThisTag";
    SyntaxKind[SyntaxKind["JSDocTypeTag"] = 354] = "JSDocTypeTag";
    SyntaxKind[SyntaxKind["JSDocTemplateTag"] = 355] = "JSDocTemplateTag";
    SyntaxKind[SyntaxKind["JSDocTypedefTag"] = 356] = "JSDocTypedefTag";
    SyntaxKind[SyntaxKind["JSDocSeeTag"] = 357] = "JSDocSeeTag";
    SyntaxKind[SyntaxKind["JSDocPropertyTag"] = 358] = "JSDocPropertyTag";
    SyntaxKind[SyntaxKind["JSDocThrowsTag"] = 359] = "JSDocThrowsTag";
    SyntaxKind[SyntaxKind["JSDocSatisfiesTag"] = 360] = "JSDocSatisfiesTag";
    SyntaxKind[SyntaxKind["JSDocImportTag"] = 361] = "JSDocImportTag";
    SyntaxKind[SyntaxKind["SyntaxList"] = 362] = "SyntaxList";
    SyntaxKind[SyntaxKind["JSTypeAliasDeclaration"] = 363] = "JSTypeAliasDeclaration";
    SyntaxKind[SyntaxKind["JSImportDeclaration"] = 364] = "JSImportDeclaration";
    SyntaxKind[SyntaxKind["NotEmittedStatement"] = 365] = "NotEmittedStatement";
    SyntaxKind[SyntaxKind["PartiallyEmittedExpression"] = 366] = "PartiallyEmittedExpression";
    SyntaxKind[SyntaxKind["SyntheticReferenceExpression"] = 367] = "SyntheticReferenceExpression";
    SyntaxKind[SyntaxKind["NotEmittedTypeElement"] = 368] = "NotEmittedTypeElement";
    SyntaxKind[SyntaxKind["Count"] = 369] = "Count";
    ...
    SyntaxKind[SyntaxKind["FirstStatement"] = 257] = "FirstStatement";
    SyntaxKind[SyntaxKind["LastStatement"] = 277] = "LastStatement";
    SyntaxKind[SyntaxKind["FirstNode"] = 167] = "FirstNode";
    SyntaxKind[SyntaxKind["FirstJSDocNode"] = 326] = "FirstJSDocNode";
    SyntaxKind[SyntaxKind["LastJSDocNode"] = 361] = "LastJSDocNode";
    SyntaxKind[SyntaxKind["FirstJSDocTagNode"] = 340] = "FirstJSDocTagNode";
    SyntaxKind[SyntaxKind["LastJSDocTagNode"] = 361] = "LastJSDocTagNode";
