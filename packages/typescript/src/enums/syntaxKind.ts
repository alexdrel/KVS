...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["KvsNullingExpression"] = 240] = "KvsNullingExpression";
    SyntaxKind[SyntaxKind["KvsConditionalElement"] = 241] = "KvsConditionalElement";
    SyntaxKind[SyntaxKind["KvsCompactArrayExpression"] = 242] = "KvsCompactArrayExpression";
    SyntaxKind[SyntaxKind["KvsCompactObjectExpression"] = 243] = "KvsCompactObjectExpression";
    SyntaxKind[SyntaxKind["KvsCollectExpression"] = 244] = "KvsCollectExpression";
    SyntaxKind[SyntaxKind["KvsSelectExpression"] = 245] = "KvsSelectExpression";
    SyntaxKind[SyntaxKind["KvsForExpression"] = 246] = "KvsForExpression";
    SyntaxKind[SyntaxKind["SpreadElement"] = 247] = "SpreadElement";
    SyntaxKind[SyntaxKind["ClassExpression"] = 248] = "ClassExpression";
    SyntaxKind[SyntaxKind["OmittedExpression"] = 249] = "OmittedExpression";
    SyntaxKind[SyntaxKind["ExpressionWithTypeArguments"] = 250] = "ExpressionWithTypeArguments";
    SyntaxKind[SyntaxKind["AsExpression"] = 251] = "AsExpression";
    SyntaxKind[SyntaxKind["NonNullExpression"] = 252] = "NonNullExpression";
    SyntaxKind[SyntaxKind["MetaProperty"] = 253] = "MetaProperty";
    SyntaxKind[SyntaxKind["SyntheticExpression"] = 254] = "SyntheticExpression";
    SyntaxKind[SyntaxKind["SatisfiesExpression"] = 255] = "SatisfiesExpression";
    SyntaxKind[SyntaxKind["TemplateSpan"] = 256] = "TemplateSpan";
    SyntaxKind[SyntaxKind["SemicolonClassElement"] = 257] = "SemicolonClassElement";
    SyntaxKind[SyntaxKind["Block"] = 258] = "Block";
    SyntaxKind[SyntaxKind["EmptyStatement"] = 259] = "EmptyStatement";
    SyntaxKind[SyntaxKind["VariableStatement"] = 260] = "VariableStatement";
    SyntaxKind[SyntaxKind["ExpressionStatement"] = 261] = "ExpressionStatement";
    SyntaxKind[SyntaxKind["IfStatement"] = 262] = "IfStatement";
    SyntaxKind[SyntaxKind["DoStatement"] = 263] = "DoStatement";
    SyntaxKind[SyntaxKind["WhileStatement"] = 264] = "WhileStatement";
    SyntaxKind[SyntaxKind["ForStatement"] = 265] = "ForStatement";
    SyntaxKind[SyntaxKind["ForInStatement"] = 266] = "ForInStatement";
    SyntaxKind[SyntaxKind["ForOfStatement"] = 267] = "ForOfStatement";
    SyntaxKind[SyntaxKind["ContinueStatement"] = 268] = "ContinueStatement";
    SyntaxKind[SyntaxKind["BreakStatement"] = 269] = "BreakStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 270] = "ReturnStatement";
    SyntaxKind[SyntaxKind["WithStatement"] = 271] = "WithStatement";
    SyntaxKind[SyntaxKind["SwitchStatement"] = 272] = "SwitchStatement";
    SyntaxKind[SyntaxKind["LabeledStatement"] = 273] = "LabeledStatement";
    SyntaxKind[SyntaxKind["ThrowStatement"] = 274] = "ThrowStatement";
    SyntaxKind[SyntaxKind["TryStatement"] = 275] = "TryStatement";
    SyntaxKind[SyntaxKind["DebuggerStatement"] = 276] = "DebuggerStatement";
    SyntaxKind[SyntaxKind["KvsExtantReturnStatement"] = 277] = "KvsExtantReturnStatement";
    SyntaxKind[SyntaxKind["KvsYieldStatement"] = 278] = "KvsYieldStatement";
    SyntaxKind[SyntaxKind["KvsExtantYieldStatement"] = 279] = "KvsExtantYieldStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingStatement"] = 280] = "KvsIfBindingStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingClause"] = 281] = "KvsIfBindingClause";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 282] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["VariableDeclarationList"] = 283] = "VariableDeclarationList";
    SyntaxKind[SyntaxKind["FunctionDeclaration"] = 284] = "FunctionDeclaration";
    SyntaxKind[SyntaxKind["ClassDeclaration"] = 285] = "ClassDeclaration";
    SyntaxKind[SyntaxKind["InterfaceDeclaration"] = 286] = "InterfaceDeclaration";
    SyntaxKind[SyntaxKind["TypeAliasDeclaration"] = 287] = "TypeAliasDeclaration";
    SyntaxKind[SyntaxKind["EnumDeclaration"] = 288] = "EnumDeclaration";
    SyntaxKind[SyntaxKind["ModuleDeclaration"] = 289] = "ModuleDeclaration";
    SyntaxKind[SyntaxKind["ModuleBlock"] = 290] = "ModuleBlock";
    SyntaxKind[SyntaxKind["CaseBlock"] = 291] = "CaseBlock";
    SyntaxKind[SyntaxKind["NamespaceExportDeclaration"] = 292] = "NamespaceExportDeclaration";
    SyntaxKind[SyntaxKind["ImportEqualsDeclaration"] = 293] = "ImportEqualsDeclaration";
    SyntaxKind[SyntaxKind["ImportDeclaration"] = 294] = "ImportDeclaration";
    SyntaxKind[SyntaxKind["ImportClause"] = 295] = "ImportClause";
    SyntaxKind[SyntaxKind["NamespaceImport"] = 296] = "NamespaceImport";
    SyntaxKind[SyntaxKind["NamedImports"] = 297] = "NamedImports";
    SyntaxKind[SyntaxKind["ImportSpecifier"] = 298] = "ImportSpecifier";
    SyntaxKind[SyntaxKind["ExportAssignment"] = 299] = "ExportAssignment";
    SyntaxKind[SyntaxKind["ExportDeclaration"] = 300] = "ExportDeclaration";
    SyntaxKind[SyntaxKind["NamedExports"] = 301] = "NamedExports";
    SyntaxKind[SyntaxKind["NamespaceExport"] = 302] = "NamespaceExport";
    SyntaxKind[SyntaxKind["ExportSpecifier"] = 303] = "ExportSpecifier";
    SyntaxKind[SyntaxKind["MissingDeclaration"] = 304] = "MissingDeclaration";
    SyntaxKind[SyntaxKind["ExternalModuleReference"] = 305] = "ExternalModuleReference";
    SyntaxKind[SyntaxKind["JsxElement"] = 306] = "JsxElement";
    SyntaxKind[SyntaxKind["JsxSelfClosingElement"] = 307] = "JsxSelfClosingElement";
    SyntaxKind[SyntaxKind["JsxOpeningElement"] = 308] = "JsxOpeningElement";
    SyntaxKind[SyntaxKind["JsxClosingElement"] = 309] = "JsxClosingElement";
    SyntaxKind[SyntaxKind["JsxFragment"] = 310] = "JsxFragment";
    SyntaxKind[SyntaxKind["JsxOpeningFragment"] = 311] = "JsxOpeningFragment";
    SyntaxKind[SyntaxKind["JsxClosingFragment"] = 312] = "JsxClosingFragment";
    SyntaxKind[SyntaxKind["JsxAttribute"] = 313] = "JsxAttribute";
    SyntaxKind[SyntaxKind["JsxAttributes"] = 314] = "JsxAttributes";
    SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 315] = "JsxSpreadAttribute";
    SyntaxKind[SyntaxKind["JsxExpression"] = 316] = "JsxExpression";
    SyntaxKind[SyntaxKind["JsxNamespacedName"] = 317] = "JsxNamespacedName";
    SyntaxKind[SyntaxKind["CaseClause"] = 318] = "CaseClause";
    SyntaxKind[SyntaxKind["DefaultClause"] = 319] = "DefaultClause";
    SyntaxKind[SyntaxKind["HeritageClause"] = 320] = "HeritageClause";
    SyntaxKind[SyntaxKind["CatchClause"] = 321] = "CatchClause";
    SyntaxKind[SyntaxKind["ImportAttributes"] = 322] = "ImportAttributes";
    SyntaxKind[SyntaxKind["ImportAttribute"] = 323] = "ImportAttribute";
    SyntaxKind[SyntaxKind["PropertyAssignment"] = 324] = "PropertyAssignment";
    SyntaxKind[SyntaxKind["ShorthandPropertyAssignment"] = 325] = "ShorthandPropertyAssignment";
    SyntaxKind[SyntaxKind["SpreadAssignment"] = 326] = "SpreadAssignment";
    SyntaxKind[SyntaxKind["EnumMember"] = 327] = "EnumMember";
    SyntaxKind[SyntaxKind["SourceFile"] = 328] = "SourceFile";
    SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 329] = "JSDocTypeExpression";
    SyntaxKind[SyntaxKind["JSDocNameReference"] = 330] = "JSDocNameReference";
    SyntaxKind[SyntaxKind["JSDocAllType"] = 331] = "JSDocAllType";
    SyntaxKind[SyntaxKind["JSDocNullableType"] = 332] = "JSDocNullableType";
    SyntaxKind[SyntaxKind["JSDocNonNullableType"] = 333] = "JSDocNonNullableType";
    SyntaxKind[SyntaxKind["JSDocOptionalType"] = 334] = "JSDocOptionalType";
    SyntaxKind[SyntaxKind["JSDocVariadicType"] = 335] = "JSDocVariadicType";
    SyntaxKind[SyntaxKind["JSDoc"] = 336] = "JSDoc";
    SyntaxKind[SyntaxKind["JSDocText"] = 337] = "JSDocText";
    SyntaxKind[SyntaxKind["JSDocTypeLiteral"] = 338] = "JSDocTypeLiteral";
    SyntaxKind[SyntaxKind["JSDocSignature"] = 339] = "JSDocSignature";
    SyntaxKind[SyntaxKind["JSDocLink"] = 340] = "JSDocLink";
    SyntaxKind[SyntaxKind["JSDocLinkCode"] = 341] = "JSDocLinkCode";
    SyntaxKind[SyntaxKind["JSDocLinkPlain"] = 342] = "JSDocLinkPlain";
    SyntaxKind[SyntaxKind["JSDocUnknownTag"] = 343] = "JSDocUnknownTag";
    SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 344] = "JSDocAugmentsTag";
    SyntaxKind[SyntaxKind["JSDocImplementsTag"] = 345] = "JSDocImplementsTag";
    SyntaxKind[SyntaxKind["JSDocDeprecatedTag"] = 346] = "JSDocDeprecatedTag";
    SyntaxKind[SyntaxKind["JSDocPublicTag"] = 347] = "JSDocPublicTag";
    SyntaxKind[SyntaxKind["JSDocPrivateTag"] = 348] = "JSDocPrivateTag";
    SyntaxKind[SyntaxKind["JSDocProtectedTag"] = 349] = "JSDocProtectedTag";
    SyntaxKind[SyntaxKind["JSDocReadonlyTag"] = 350] = "JSDocReadonlyTag";
    SyntaxKind[SyntaxKind["JSDocOverrideTag"] = 351] = "JSDocOverrideTag";
    SyntaxKind[SyntaxKind["JSDocCallbackTag"] = 352] = "JSDocCallbackTag";
    SyntaxKind[SyntaxKind["JSDocOverloadTag"] = 353] = "JSDocOverloadTag";
    SyntaxKind[SyntaxKind["JSDocParameterTag"] = 354] = "JSDocParameterTag";
    SyntaxKind[SyntaxKind["JSDocReturnTag"] = 355] = "JSDocReturnTag";
    SyntaxKind[SyntaxKind["JSDocThisTag"] = 356] = "JSDocThisTag";
    SyntaxKind[SyntaxKind["JSDocTypeTag"] = 357] = "JSDocTypeTag";
    SyntaxKind[SyntaxKind["JSDocTemplateTag"] = 358] = "JSDocTemplateTag";
    SyntaxKind[SyntaxKind["JSDocTypedefTag"] = 359] = "JSDocTypedefTag";
    SyntaxKind[SyntaxKind["JSDocSeeTag"] = 360] = "JSDocSeeTag";
    SyntaxKind[SyntaxKind["JSDocPropertyTag"] = 361] = "JSDocPropertyTag";
    SyntaxKind[SyntaxKind["JSDocThrowsTag"] = 362] = "JSDocThrowsTag";
    SyntaxKind[SyntaxKind["JSDocSatisfiesTag"] = 363] = "JSDocSatisfiesTag";
    SyntaxKind[SyntaxKind["JSDocImportTag"] = 364] = "JSDocImportTag";
    SyntaxKind[SyntaxKind["SyntaxList"] = 365] = "SyntaxList";
    SyntaxKind[SyntaxKind["JSTypeAliasDeclaration"] = 366] = "JSTypeAliasDeclaration";
    SyntaxKind[SyntaxKind["JSImportDeclaration"] = 367] = "JSImportDeclaration";
    SyntaxKind[SyntaxKind["NotEmittedStatement"] = 368] = "NotEmittedStatement";
    SyntaxKind[SyntaxKind["PartiallyEmittedExpression"] = 369] = "PartiallyEmittedExpression";
    SyntaxKind[SyntaxKind["SyntheticReferenceExpression"] = 370] = "SyntheticReferenceExpression";
    SyntaxKind[SyntaxKind["NotEmittedTypeElement"] = 371] = "NotEmittedTypeElement";
    SyntaxKind[SyntaxKind["Count"] = 372] = "Count";
    ...
    SyntaxKind[SyntaxKind["FirstStatement"] = 260] = "FirstStatement";
    SyntaxKind[SyntaxKind["LastStatement"] = 280] = "LastStatement";
    SyntaxKind[SyntaxKind["FirstNode"] = 167] = "FirstNode";
    SyntaxKind[SyntaxKind["FirstJSDocNode"] = 329] = "FirstJSDocNode";
    SyntaxKind[SyntaxKind["LastJSDocNode"] = 364] = "LastJSDocNode";
    SyntaxKind[SyntaxKind["FirstJSDocTagNode"] = 343] = "FirstJSDocTagNode";
    SyntaxKind[SyntaxKind["LastJSDocTagNode"] = 364] = "LastJSDocTagNode";
