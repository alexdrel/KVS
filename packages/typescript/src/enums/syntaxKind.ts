...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["KvsNullingSieveExpression"] = 238] = "KvsNullingSieveExpression";
    SyntaxKind[SyntaxKind["KvsSieveBindingInitializer"] = 239] = "KvsSieveBindingInitializer";
    SyntaxKind[SyntaxKind["KvsComparisonAlternativesExpression"] = 240] = "KvsComparisonAlternativesExpression";
    SyntaxKind[SyntaxKind["KvsComparisonChainExpression"] = 241] = "KvsComparisonChainExpression";
    SyntaxKind[SyntaxKind["KvsNullingExpression"] = 242] = "KvsNullingExpression";
    SyntaxKind[SyntaxKind["KvsConditionalElement"] = 243] = "KvsConditionalElement";
    SyntaxKind[SyntaxKind["KvsCompactArrayExpression"] = 244] = "KvsCompactArrayExpression";
    SyntaxKind[SyntaxKind["KvsCompactObjectExpression"] = 245] = "KvsCompactObjectExpression";
    SyntaxKind[SyntaxKind["KvsCollectExpression"] = 246] = "KvsCollectExpression";
    SyntaxKind[SyntaxKind["KvsSelectExpression"] = 247] = "KvsSelectExpression";
    SyntaxKind[SyntaxKind["KvsForExpression"] = 248] = "KvsForExpression";
    SyntaxKind[SyntaxKind["SpreadElement"] = 249] = "SpreadElement";
    SyntaxKind[SyntaxKind["ClassExpression"] = 250] = "ClassExpression";
    SyntaxKind[SyntaxKind["OmittedExpression"] = 251] = "OmittedExpression";
    SyntaxKind[SyntaxKind["ExpressionWithTypeArguments"] = 252] = "ExpressionWithTypeArguments";
    SyntaxKind[SyntaxKind["AsExpression"] = 253] = "AsExpression";
    SyntaxKind[SyntaxKind["NonNullExpression"] = 254] = "NonNullExpression";
    SyntaxKind[SyntaxKind["MetaProperty"] = 255] = "MetaProperty";
    SyntaxKind[SyntaxKind["SyntheticExpression"] = 256] = "SyntheticExpression";
    SyntaxKind[SyntaxKind["SatisfiesExpression"] = 257] = "SatisfiesExpression";
    SyntaxKind[SyntaxKind["TemplateSpan"] = 258] = "TemplateSpan";
    SyntaxKind[SyntaxKind["SemicolonClassElement"] = 259] = "SemicolonClassElement";
    SyntaxKind[SyntaxKind["Block"] = 260] = "Block";
    SyntaxKind[SyntaxKind["EmptyStatement"] = 261] = "EmptyStatement";
    SyntaxKind[SyntaxKind["VariableStatement"] = 262] = "VariableStatement";
    SyntaxKind[SyntaxKind["ExpressionStatement"] = 263] = "ExpressionStatement";
    SyntaxKind[SyntaxKind["IfStatement"] = 264] = "IfStatement";
    SyntaxKind[SyntaxKind["DoStatement"] = 265] = "DoStatement";
    SyntaxKind[SyntaxKind["WhileStatement"] = 266] = "WhileStatement";
    SyntaxKind[SyntaxKind["ForStatement"] = 267] = "ForStatement";
    SyntaxKind[SyntaxKind["ForInStatement"] = 268] = "ForInStatement";
    SyntaxKind[SyntaxKind["ForOfStatement"] = 269] = "ForOfStatement";
    SyntaxKind[SyntaxKind["ContinueStatement"] = 270] = "ContinueStatement";
    SyntaxKind[SyntaxKind["BreakStatement"] = 271] = "BreakStatement";
    SyntaxKind[SyntaxKind["ReturnStatement"] = 272] = "ReturnStatement";
    SyntaxKind[SyntaxKind["WithStatement"] = 273] = "WithStatement";
    SyntaxKind[SyntaxKind["SwitchStatement"] = 274] = "SwitchStatement";
    SyntaxKind[SyntaxKind["LabeledStatement"] = 275] = "LabeledStatement";
    SyntaxKind[SyntaxKind["ThrowStatement"] = 276] = "ThrowStatement";
    SyntaxKind[SyntaxKind["TryStatement"] = 277] = "TryStatement";
    SyntaxKind[SyntaxKind["DebuggerStatement"] = 278] = "DebuggerStatement";
    SyntaxKind[SyntaxKind["KvsExtantReturnStatement"] = 279] = "KvsExtantReturnStatement";
    SyntaxKind[SyntaxKind["KvsYieldStatement"] = 280] = "KvsYieldStatement";
    SyntaxKind[SyntaxKind["KvsExtantYieldStatement"] = 281] = "KvsExtantYieldStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingStatement"] = 282] = "KvsIfBindingStatement";
    SyntaxKind[SyntaxKind["KvsIfBindingClause"] = 283] = "KvsIfBindingClause";
    SyntaxKind[SyntaxKind["VariableDeclaration"] = 284] = "VariableDeclaration";
    SyntaxKind[SyntaxKind["VariableDeclarationList"] = 285] = "VariableDeclarationList";
    SyntaxKind[SyntaxKind["FunctionDeclaration"] = 286] = "FunctionDeclaration";
    SyntaxKind[SyntaxKind["ClassDeclaration"] = 287] = "ClassDeclaration";
    SyntaxKind[SyntaxKind["InterfaceDeclaration"] = 288] = "InterfaceDeclaration";
    SyntaxKind[SyntaxKind["TypeAliasDeclaration"] = 289] = "TypeAliasDeclaration";
    SyntaxKind[SyntaxKind["EnumDeclaration"] = 290] = "EnumDeclaration";
    SyntaxKind[SyntaxKind["ModuleDeclaration"] = 291] = "ModuleDeclaration";
    SyntaxKind[SyntaxKind["ModuleBlock"] = 292] = "ModuleBlock";
    SyntaxKind[SyntaxKind["CaseBlock"] = 293] = "CaseBlock";
    SyntaxKind[SyntaxKind["NamespaceExportDeclaration"] = 294] = "NamespaceExportDeclaration";
    SyntaxKind[SyntaxKind["ImportEqualsDeclaration"] = 295] = "ImportEqualsDeclaration";
    SyntaxKind[SyntaxKind["ImportDeclaration"] = 296] = "ImportDeclaration";
    SyntaxKind[SyntaxKind["ImportClause"] = 297] = "ImportClause";
    SyntaxKind[SyntaxKind["NamespaceImport"] = 298] = "NamespaceImport";
    SyntaxKind[SyntaxKind["NamedImports"] = 299] = "NamedImports";
    SyntaxKind[SyntaxKind["ImportSpecifier"] = 300] = "ImportSpecifier";
    SyntaxKind[SyntaxKind["ExportAssignment"] = 301] = "ExportAssignment";
    SyntaxKind[SyntaxKind["ExportDeclaration"] = 302] = "ExportDeclaration";
    SyntaxKind[SyntaxKind["NamedExports"] = 303] = "NamedExports";
    SyntaxKind[SyntaxKind["NamespaceExport"] = 304] = "NamespaceExport";
    SyntaxKind[SyntaxKind["ExportSpecifier"] = 305] = "ExportSpecifier";
    SyntaxKind[SyntaxKind["MissingDeclaration"] = 306] = "MissingDeclaration";
    SyntaxKind[SyntaxKind["ExternalModuleReference"] = 307] = "ExternalModuleReference";
    SyntaxKind[SyntaxKind["JsxElement"] = 308] = "JsxElement";
    SyntaxKind[SyntaxKind["JsxSelfClosingElement"] = 309] = "JsxSelfClosingElement";
    SyntaxKind[SyntaxKind["JsxOpeningElement"] = 310] = "JsxOpeningElement";
    SyntaxKind[SyntaxKind["JsxClosingElement"] = 311] = "JsxClosingElement";
    SyntaxKind[SyntaxKind["JsxFragment"] = 312] = "JsxFragment";
    SyntaxKind[SyntaxKind["JsxOpeningFragment"] = 313] = "JsxOpeningFragment";
    SyntaxKind[SyntaxKind["JsxClosingFragment"] = 314] = "JsxClosingFragment";
    SyntaxKind[SyntaxKind["JsxAttribute"] = 315] = "JsxAttribute";
    SyntaxKind[SyntaxKind["JsxAttributes"] = 316] = "JsxAttributes";
    SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 317] = "JsxSpreadAttribute";
    SyntaxKind[SyntaxKind["JsxExpression"] = 318] = "JsxExpression";
    SyntaxKind[SyntaxKind["JsxNamespacedName"] = 319] = "JsxNamespacedName";
    SyntaxKind[SyntaxKind["CaseClause"] = 320] = "CaseClause";
    SyntaxKind[SyntaxKind["DefaultClause"] = 321] = "DefaultClause";
    SyntaxKind[SyntaxKind["HeritageClause"] = 322] = "HeritageClause";
    SyntaxKind[SyntaxKind["CatchClause"] = 323] = "CatchClause";
    SyntaxKind[SyntaxKind["ImportAttributes"] = 324] = "ImportAttributes";
    SyntaxKind[SyntaxKind["ImportAttribute"] = 325] = "ImportAttribute";
    SyntaxKind[SyntaxKind["PropertyAssignment"] = 326] = "PropertyAssignment";
    SyntaxKind[SyntaxKind["ShorthandPropertyAssignment"] = 327] = "ShorthandPropertyAssignment";
    SyntaxKind[SyntaxKind["SpreadAssignment"] = 328] = "SpreadAssignment";
    SyntaxKind[SyntaxKind["EnumMember"] = 329] = "EnumMember";
    SyntaxKind[SyntaxKind["SourceFile"] = 330] = "SourceFile";
    SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 331] = "JSDocTypeExpression";
    SyntaxKind[SyntaxKind["JSDocNameReference"] = 332] = "JSDocNameReference";
    SyntaxKind[SyntaxKind["JSDocAllType"] = 333] = "JSDocAllType";
    SyntaxKind[SyntaxKind["JSDocNullableType"] = 334] = "JSDocNullableType";
    SyntaxKind[SyntaxKind["JSDocNonNullableType"] = 335] = "JSDocNonNullableType";
    SyntaxKind[SyntaxKind["JSDocOptionalType"] = 336] = "JSDocOptionalType";
    SyntaxKind[SyntaxKind["JSDocVariadicType"] = 337] = "JSDocVariadicType";
    SyntaxKind[SyntaxKind["JSDoc"] = 338] = "JSDoc";
    SyntaxKind[SyntaxKind["JSDocText"] = 339] = "JSDocText";
    SyntaxKind[SyntaxKind["JSDocTypeLiteral"] = 340] = "JSDocTypeLiteral";
    SyntaxKind[SyntaxKind["JSDocSignature"] = 341] = "JSDocSignature";
    SyntaxKind[SyntaxKind["JSDocLink"] = 342] = "JSDocLink";
    SyntaxKind[SyntaxKind["JSDocLinkCode"] = 343] = "JSDocLinkCode";
    SyntaxKind[SyntaxKind["JSDocLinkPlain"] = 344] = "JSDocLinkPlain";
    SyntaxKind[SyntaxKind["JSDocUnknownTag"] = 345] = "JSDocUnknownTag";
    SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 346] = "JSDocAugmentsTag";
    SyntaxKind[SyntaxKind["JSDocImplementsTag"] = 347] = "JSDocImplementsTag";
    SyntaxKind[SyntaxKind["JSDocDeprecatedTag"] = 348] = "JSDocDeprecatedTag";
    SyntaxKind[SyntaxKind["JSDocPublicTag"] = 349] = "JSDocPublicTag";
    SyntaxKind[SyntaxKind["JSDocPrivateTag"] = 350] = "JSDocPrivateTag";
    SyntaxKind[SyntaxKind["JSDocProtectedTag"] = 351] = "JSDocProtectedTag";
    SyntaxKind[SyntaxKind["JSDocReadonlyTag"] = 352] = "JSDocReadonlyTag";
    SyntaxKind[SyntaxKind["JSDocOverrideTag"] = 353] = "JSDocOverrideTag";
    SyntaxKind[SyntaxKind["JSDocCallbackTag"] = 354] = "JSDocCallbackTag";
    SyntaxKind[SyntaxKind["JSDocOverloadTag"] = 355] = "JSDocOverloadTag";
    SyntaxKind[SyntaxKind["JSDocParameterTag"] = 356] = "JSDocParameterTag";
    SyntaxKind[SyntaxKind["JSDocReturnTag"] = 357] = "JSDocReturnTag";
    SyntaxKind[SyntaxKind["JSDocThisTag"] = 358] = "JSDocThisTag";
    SyntaxKind[SyntaxKind["JSDocTypeTag"] = 359] = "JSDocTypeTag";
    SyntaxKind[SyntaxKind["JSDocTemplateTag"] = 360] = "JSDocTemplateTag";
    SyntaxKind[SyntaxKind["JSDocTypedefTag"] = 361] = "JSDocTypedefTag";
    SyntaxKind[SyntaxKind["JSDocSeeTag"] = 362] = "JSDocSeeTag";
    SyntaxKind[SyntaxKind["JSDocPropertyTag"] = 363] = "JSDocPropertyTag";
    SyntaxKind[SyntaxKind["JSDocThrowsTag"] = 364] = "JSDocThrowsTag";
    SyntaxKind[SyntaxKind["JSDocSatisfiesTag"] = 365] = "JSDocSatisfiesTag";
    SyntaxKind[SyntaxKind["JSDocImportTag"] = 366] = "JSDocImportTag";
    SyntaxKind[SyntaxKind["SyntaxList"] = 367] = "SyntaxList";
    SyntaxKind[SyntaxKind["JSTypeAliasDeclaration"] = 368] = "JSTypeAliasDeclaration";
    SyntaxKind[SyntaxKind["JSImportDeclaration"] = 369] = "JSImportDeclaration";
    SyntaxKind[SyntaxKind["NotEmittedStatement"] = 370] = "NotEmittedStatement";
    SyntaxKind[SyntaxKind["PartiallyEmittedExpression"] = 371] = "PartiallyEmittedExpression";
    SyntaxKind[SyntaxKind["SyntheticReferenceExpression"] = 372] = "SyntheticReferenceExpression";
    SyntaxKind[SyntaxKind["NotEmittedTypeElement"] = 373] = "NotEmittedTypeElement";
    SyntaxKind[SyntaxKind["Count"] = 374] = "Count";
    ...
    SyntaxKind[SyntaxKind["FirstStatement"] = 262] = "FirstStatement";
    SyntaxKind[SyntaxKind["LastStatement"] = 282] = "LastStatement";
    SyntaxKind[SyntaxKind["FirstNode"] = 167] = "FirstNode";
    SyntaxKind[SyntaxKind["FirstJSDocNode"] = 331] = "FirstJSDocNode";
    SyntaxKind[SyntaxKind["LastJSDocNode"] = 366] = "LastJSDocNode";
    SyntaxKind[SyntaxKind["FirstJSDocTagNode"] = 345] = "FirstJSDocTagNode";
    SyntaxKind[SyntaxKind["LastJSDocTagNode"] = 366] = "LastJSDocTagNode";
