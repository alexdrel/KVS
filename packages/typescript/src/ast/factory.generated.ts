...
export class NodeObject {
    ...
    get firstTildeToken(): any {
        return this._data?.firstTildeToken;
    }
    get forIn(): any {
    ...
    get secondTildeToken(): any {
        return this._data?.secondTildeToken;
    }
    get spanMap(): any {
...
const forEachChildTable: Record<number, ForEachChildFunction> = {
    ...
    [SyntaxKind.KvsTypedObjectExpression]: (data, cbNode, cbNodes) =>
        ...
        visitNodes(cbNode, cbNodes, data.properties),
    [SyntaxKind.KvsRangeExpression]: (data, cbNode, cbNodes) =>
    ...
    [SyntaxKind.KvsCollectExpression]: (data, cbNode, cbNodes) =>
        ...
        visitNode(cbNode, data.expression) ||
        visitNode(cbNode, data.statement),
    [SyntaxKind.KvsLazyCollectExpression]: (data, cbNode, cbNodes) =>
        visitNode(cbNode, data.initializer) ||
        visitNode(cbNode, data.expression) ||
        visitNode(cbNode, data.statement),
...
const yieldEachChildTable: Record<number, YieldEachChildFunction> = {
    ...
    [SyntaxKind.KvsExtantReturnStatement]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsYieldStatement]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsExtantYieldStatement]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsIfBindingStatement]: function* (data) {
        if (data.clause) {
            const res = yield data.clause;
            if (res) return res;
        }
        if (data.elseStatement) {
            const res = yield data.elseStatement;
    ...
    [SyntaxKind.KvsIfBindingClause]: function* (data) {
    ...
    [SyntaxKind.KvsNullableAssertionExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsExtantAssertionExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsExtantAssignmentExpression]: function* (data) {
        if (data.left) {
            const res = yield data.left;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsTypedSpreadAssignmentExpression]: function* (data) {
        if (data.left) {
            const res = yield data.left;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsDefaultExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsSieveExpression]: function* (data) {
        if (data.firstTildeToken) {
            const res = yield data.firstTildeToken;
            if (res) return res;
        }
        if (data.secondTildeToken) {
            const res = yield data.secondTildeToken;
            if (res) return res;
        }
        if (data.expression) {
            const res = yield data.expression;
    ...
    [SyntaxKind.KvsSieveBindingInitializer]: function* (data) {
        if (data.tildeToken) {
            const res = yield data.tildeToken;
            if (res) return res;
        }
        if (data.equalsToken) {
            const res = yield data.equalsToken;
    ...
    [SyntaxKind.KvsSieveAssignmentExpression]: function* (data) {
        if (data.left) {
            const res = yield data.left;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsFailureDemotionExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
        ...
        if (data.pattern) {
            const res = yield data.pattern;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsFailurePromotionExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
        ...
        if (data.replacement) {
            const res = yield data.replacement;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsCatchSplitExpression]: function* (data) {
        if (data.expression) {
            const res = yield data.expression;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsCatchSplitAssignmentExpression]: function* (data) {
        if (data.valueTarget) {
            const res = yield data.valueTarget;
            if (res) return res;
        }
        if (data.tildeToken) {
            const res = yield data.tildeToken;
        ...
        if (data.errorTarget) {
            const res = yield data.errorTarget;
            if (res) return res;
        }
        if (data.equalsToken) {
            const res = yield data.equalsToken;
    ...
    [SyntaxKind.KvsComparisonAlternativesExpression]: function* (data) {
        if (data.subject) {
            const res = yield data.subject;
            if (res) return res;
        }
        ...
        if (data.spreadToken) {
            const res = yield data.spreadToken;
            if (res) return res;
        }
        for (const n of data.alternatives) {
            const res = yield n;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsComparisonChainExpression]: function* (data) {
        for (const n of data.operands) {
            const res = yield n;
            if (res) return res;
        }
        for (const n of data.operators) {
            const res = yield n;
            if (res) return res;
        }
    },
    [SyntaxKind.KvsNullingExpression]: function* (data) {
        if (data.condition) {
            const res = yield data.condition;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsCompactArrayExpression]: function* (data) {
        if (data.questionToken) {
            const res = yield data.questionToken;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsConditionalElement]: function* (data) {
        if (data.questionToken) {
            const res = yield data.questionToken;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsCompactObjectExpression]: function* (data) {
        if (data.questionToken) {
            const res = yield data.questionToken;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsTypedObjectExpression]: function* (data) {
        if (data.type) {
    ...
    [SyntaxKind.KvsRangeExpression]: function* (data) {
        if (data.lower) {
            const res = yield data.lower;
            if (res) return res;
        }
        if (data.operatorToken) {
            const res = yield data.operatorToken;
    ...
    [SyntaxKind.KvsCollectExpression]: function* (data) {
        if (data.initializer) {
            const res = yield data.initializer;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsLazyCollectExpression]: function* (data) {
        if (data.initializer) {
            const res = yield data.initializer;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsSelectExpression]: function* (data) {
        if (data.initializer) {
            const res = yield data.initializer;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsForExpression]: function* (data) {
        if (data.initializer) {
            const res = yield data.initializer;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsNullableType]: function* (data) {
        if (data.type) {
            const res = yield data.type;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsExtantType]: function* (data) {
        if (data.type) {
            const res = yield data.type;
            if (res) return res;
        }
    ...
    [SyntaxKind.KvsCatchSplitBindingPattern]: function* (data) {
        for (const n of data.elements) {
            const res = yield n;
            if (res) return res;
        }
...
export function createKvsRangeExpression(lower: Expression, operatorToken: Node, upper: Expression): KvsRangeExpression {
    return new NodeObject(SyntaxKind.KvsRangeExpression, {
        lower,
        operatorToken,
        upper,
