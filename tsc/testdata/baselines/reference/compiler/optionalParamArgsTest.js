...
class C1 {
    ...
    // C1M4 contains a mix of optional and non-optional parameters
    C1M4(C1M4A1, C1M4A2) { var _a, _b; return _a = C1M4A1, (_b = C1M4A2) != null ? _a + _b : null; }
...
function F3(F3A1 = 0, F3A2 = F3A1) { return F3A1 + F3A2; }
function F4(F4A1, F4A2) { var _a, _b; return _a = F4A1, (_b = F4A2) != null ? _a + _b : null; }
var L1 = function () { return 0; };
var L2 = function (L2A1) { return L2A1; };
var L3 = function (L3A1 = 0, L3A2 = L3A1) { return L3A1 + L3A2; };
var L4 = function (L4A1, L4A2) { var _a, _b; return _a = L4A1, (_b = L4A2) != null ? _a + _b : null; };
var c1o1 = new C1(5);
var i1o1 = new C1(5);
// Valid
c1o1.C1M1();
