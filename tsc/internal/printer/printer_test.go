...
func TestEmit(t *testing.T) {
	...
	data := []struct {
		...
		{title: "SwitchStatement", input: `switch (a) {default: break;}`, output: "switch (a) {\n    default: break;\n}"},
		{title: "CaseClause#1", input: `switch (a) {case b: break;}`, output: "switch (a) {\n    case b: break;\n}"},
		{title: "CaseClause#2", input: `switch (a) {case b:; break;}`, output: "switch (a) {\n    case b:\n        ;\n        break;\n}"},
		{title: "DefaultClause#1", input: `switch (a) {default: break;}`, output: "switch (a) {\n    default: break;\n}"},
		{title: "DefaultClause#2", input: `switch (a) {default:; break;}`, output: "switch (a) {\n    default:\n        ;\n        break;\n}"},
...
func TestNoTrailingCommaAfterTransform(t *testing.T) {
	...
	visitor = emitContext.NewNodeVisitor(func(node *ast.Node) *ast.Node {
		switch node.Kind {
		case ast.KindNonNullExpression, ast.KindKvsDefaultExpression:
