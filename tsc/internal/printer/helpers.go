...
var KvsKeyedIterationHelper = &EmitHelper{
	Name:       "kvs:keyedIteration",
	ImportName: "__kvsKeyed",
	Scoped:     false,
	Text: `var __kvsKeyed = (this && this.__kvsKeyed) || function (source, record, async) {
    var keyed = {};
    var create = function () {
