...
type KvsExtantReturnStatement struct {
	StatementBase
	CompositeBase
	Expression *Expression
}

func (f *NodeFactory) NewKvsExtantReturnStatement(expression *Expression) *Node {
	data := f.kvsExtantReturnStatementArena.New()
	data.Expression = expression
	return f.newNode(KindKvsExtantReturnStatement, data)
}

func (f *NodeFactory) UpdateKvsExtantReturnStatement(node *KvsExtantReturnStatement, expression *Expression) *Node {
	if expression != node.Expression {
		return updateNode(f.NewKvsExtantReturnStatement(expression), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsExtantReturnStatement) ForEachChild(v Visitor) bool {
	return visit(v, node.Expression)
}

func (node *KvsExtantReturnStatement) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsExtantReturnStatement(node, v.visitNode(node.Expression))
}

func (node *KvsExtantReturnStatement) Clone(f NodeFactoryCoercible) *Node {
...
type KvsYieldStatement struct {
	StatementBase
	CompositeBase
	Expression *Expression
}

func (f *NodeFactory) NewKvsYieldStatement(expression *Expression) *Node {
	data := f.kvsYieldStatementArena.New()
	data.Expression = expression
	return f.newNode(KindKvsYieldStatement, data)
}

func (f *NodeFactory) UpdateKvsYieldStatement(node *KvsYieldStatement, expression *Expression) *Node {
	if expression != node.Expression {
		return updateNode(f.NewKvsYieldStatement(expression), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsYieldStatement) ForEachChild(v Visitor) bool {
	return visit(v, node.Expression)
}

func (node *KvsYieldStatement) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsYieldStatement(node, v.visitNode(node.Expression))
}

func (node *KvsYieldStatement) Clone(f NodeFactoryCoercible) *Node {
...
type KvsExtantYieldStatement struct {
	StatementBase
	CompositeBase
	Expression *Expression
}

func (f *NodeFactory) NewKvsExtantYieldStatement(expression *Expression) *Node {
	data := f.kvsExtantYieldStatementArena.New()
	data.Expression = expression
	return f.newNode(KindKvsExtantYieldStatement, data)
}

func (f *NodeFactory) UpdateKvsExtantYieldStatement(node *KvsExtantYieldStatement, expression *Expression) *Node {
	if expression != node.Expression {
		return updateNode(f.NewKvsExtantYieldStatement(expression), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsExtantYieldStatement) ForEachChild(v Visitor) bool {
	return visit(v, node.Expression)
}

func (node *KvsExtantYieldStatement) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsExtantYieldStatement(node, v.visitNode(node.Expression))
}
...
func IsKvsExtantYieldStatement(node *Node) bool {
	return node.Kind == KindKvsExtantYieldStatement
}
...
type KvsNullableAssertionExpression struct {
	ExpressionBase
	CompositeBase
	Expression    *Expression
...
func (f *NodeFactory) NewKvsNullableAssertionExpression(expression *Expression, questionToken *QuestionToken) *Node {
	data := f.kvsNullableAssertionExpressionArena.New()
	data.Expression = expression
	data.QuestionToken = questionToken
	return f.newNode(KindKvsNullableAssertionExpression, data)
}

func (f *NodeFactory) UpdateKvsNullableAssertionExpression(node *KvsNullableAssertionExpression, expression *Expression, questionToken *QuestionToken) *Node {
	if expression != node.Expression || questionToken != node.QuestionToken {
		return updateNode(f.NewKvsNullableAssertionExpression(expression, questionToken), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsNullableAssertionExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.Expression) || visit(v, node.QuestionToken)
}

func (node *KvsNullableAssertionExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsNullableAssertionExpression(node, v.visitNode(node.Expression), v.visitNode(node.QuestionToken))
}

func (node *KvsNullableAssertionExpression) Clone(f NodeFactoryCoercible) *Node {
	return cloneNode(f.AsNodeFactory().NewKvsNullableAssertionExpression(node.Expression, node.QuestionToken), node.AsNode(), f.AsNodeFactory().hooks)
}

func IsKvsNullableAssertionExpression(node *Node) bool {
	return node.Kind == KindKvsNullableAssertionExpression
}
...
type KvsExtantAssertionExpression struct {
	ExpressionBase
	CompositeBase
	Expression       *Expression
...
func (f *NodeFactory) NewKvsExtantAssertionExpression(expression *Expression, exclamationToken *ExclamationToken) *Node {
	data := f.kvsExtantAssertionExpressionArena.New()
	data.Expression = expression
	data.ExclamationToken = exclamationToken
	return f.newNode(KindKvsExtantAssertionExpression, data)
}

func (f *NodeFactory) UpdateKvsExtantAssertionExpression(node *KvsExtantAssertionExpression, expression *Expression, exclamationToken *ExclamationToken) *Node {
	if expression != node.Expression || exclamationToken != node.ExclamationToken {
		return updateNode(f.NewKvsExtantAssertionExpression(expression, exclamationToken), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsExtantAssertionExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.Expression) || visit(v, node.ExclamationToken)
}

func (node *KvsExtantAssertionExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsExtantAssertionExpression(node, v.visitNode(node.Expression), v.visitNode(node.ExclamationToken))
}

func (node *KvsExtantAssertionExpression) Clone(f NodeFactoryCoercible) *Node {
	return cloneNode(f.AsNodeFactory().NewKvsExtantAssertionExpression(node.Expression, node.ExclamationToken), node.AsNode(), f.AsNodeFactory().hooks)
}

func IsKvsExtantAssertionExpression(node *Node) bool {
	return node.Kind == KindKvsExtantAssertionExpression
}
...
type KvsExtantAssignmentExpression struct {
	ExpressionBase
	CompositeBase
	Left          *Expression
	QuestionToken *QuestionToken
...
func (f *NodeFactory) NewKvsExtantAssignmentExpression(left *Expression, questionToken *QuestionToken, equalsToken *EqualsToken, right *Expression) *Node {
	data := f.kvsExtantAssignmentExpressionArena.New()
	data.Left = left
	data.QuestionToken = questionToken
	data.EqualsToken = equalsToken
	data.Right = right
	return f.newNode(KindKvsExtantAssignmentExpression, data)
}

func (f *NodeFactory) UpdateKvsExtantAssignmentExpression(node *KvsExtantAssignmentExpression, left *Expression, questionToken *QuestionToken, equalsToken *EqualsToken, right *Expression) *Node {
	if left != node.Left || questionToken != node.QuestionToken || equalsToken != node.EqualsToken || right != node.Right {
		return updateNode(f.NewKvsExtantAssignmentExpression(left, questionToken, equalsToken, right), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsExtantAssignmentExpression) ForEachChild(v Visitor) bool {
...
func (node *KvsExtantAssignmentExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsExtantAssignmentExpression(node, v.visitNode(node.Left), v.visitNode(node.QuestionToken), v.visitNode(node.EqualsToken), v.visitNode(node.Right))
}

func (node *KvsExtantAssignmentExpression) Clone(f NodeFactoryCoercible) *Node {
...
type KvsSieveExpression struct {
	ExpressionBase
	CompositeBase
...
func (f *NodeFactory) NewKvsSieveExpression(firstTildeToken *TildeToken, secondTildeToken *TildeToken, expression *Expression) *Node {
	data := f.kvsSieveExpressionArena.New()
	data.FirstTildeToken = firstTildeToken
	data.SecondTildeToken = secondTildeToken
	data.Expression = expression
	return f.newNode(KindKvsSieveExpression, data)
}

func (f *NodeFactory) UpdateKvsSieveExpression(node *KvsSieveExpression, firstTildeToken *TildeToken, secondTildeToken *TildeToken, expression *Expression) *Node {
	if firstTildeToken != node.FirstTildeToken || secondTildeToken != node.SecondTildeToken || expression != node.Expression {
		return updateNode(f.NewKvsSieveExpression(firstTildeToken, secondTildeToken, expression), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsSieveExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.FirstTildeToken) || visit(v, node.SecondTildeToken) || visit(v, node.Expression)
}

func (node *KvsSieveExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsSieveExpression(node, v.visitNode(node.FirstTildeToken), v.visitNode(node.SecondTildeToken), v.visitNode(node.Expression))
}

func (node *KvsSieveExpression) Clone(f NodeFactoryCoercible) *Node {
...
type KvsPlaceholderLambdaExpression struct {
	ExpressionBase
	CompositeBase
	Arrow *ArrowFunctionNode
}

func (f *NodeFactory) NewKvsPlaceholderLambdaExpression(arrow *ArrowFunctionNode) *Node {
	data := f.kvsPlaceholderLambdaExpressionArena.New()
	data.Arrow = arrow
	return f.newNode(KindKvsPlaceholderLambdaExpression, data)
}

func (f *NodeFactory) UpdateKvsPlaceholderLambdaExpression(node *KvsPlaceholderLambdaExpression, arrow *ArrowFunctionNode) *Node {
	if arrow != node.Arrow {
		return updateNode(f.NewKvsPlaceholderLambdaExpression(arrow), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsPlaceholderLambdaExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.Arrow)
}

func (node *KvsPlaceholderLambdaExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsPlaceholderLambdaExpression(node, v.visitNode(node.Arrow))
}

func (node *KvsPlaceholderLambdaExpression) Clone(f NodeFactoryCoercible) *Node {
...
type KvsConditionalElement struct {
	ExpressionBase
	CompositeBase
	QuestionToken *QuestionToken
	ColonToken    *ColonToken
...
func (f *NodeFactory) NewKvsConditionalElement(questionToken *QuestionToken, colonToken *ColonToken, expression *Expression) *Node {
	data := &KvsConditionalElement{}
	data.QuestionToken = questionToken
	data.ColonToken = colonToken
	data.Expression = expression
	return f.newNode(KindKvsConditionalElement, data)
}

func (f *NodeFactory) UpdateKvsConditionalElement(node *KvsConditionalElement, questionToken *QuestionToken, colonToken *ColonToken, expression *Expression) *Node {
	if questionToken != node.QuestionToken || colonToken != node.ColonToken || expression != node.Expression {
		return updateNode(f.NewKvsConditionalElement(questionToken, colonToken, expression), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsConditionalElement) ForEachChild(v Visitor) bool {
	return visit(v, node.QuestionToken) || visit(v, node.ColonToken) || visit(v, node.Expression)
}

func (node *KvsConditionalElement) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsConditionalElement(node, v.visitNode(node.QuestionToken), v.visitNode(node.ColonToken), v.visitNode(node.Expression))
}

func (node *KvsConditionalElement) Clone(f NodeFactoryCoercible) *Node {
	return cloneNode(f.AsNodeFactory().NewKvsConditionalElement(node.QuestionToken, node.ColonToken, node.Expression), node.AsNode(), f.AsNodeFactory().hooks)
}

func (node *KvsConditionalElement) computeSubtreeFacts() SubtreeFacts {
	return propagateSubtreeFacts(node.QuestionToken) |
		propagateSubtreeFacts(node.ColonToken) |
		propagateSubtreeFacts(node.Expression)
}

func IsKvsConditionalElement(node *Node) bool {
	return node.Kind == KindKvsConditionalElement
}
...
type KvsCompactObjectExpression struct {
	PrimaryExpressionBase
	DeclarationBase
	CompositeBase
	QuestionToken *QuestionToken
...
func (f *NodeFactory) NewKvsCompactObjectExpression(questionToken *QuestionToken, properties *NodeList, multiLine bool) *Node {
	data := &KvsCompactObjectExpression{}
	data.QuestionToken = questionToken
	data.Properties = properties
	data.MultiLine = multiLine
	return f.newNode(KindKvsCompactObjectExpression, data)
}

func (f *NodeFactory) UpdateKvsCompactObjectExpression(node *KvsCompactObjectExpression, questionToken *QuestionToken, properties *NodeList, multiLine bool) *Node {
	if questionToken != node.QuestionToken || properties != node.Properties || multiLine != node.MultiLine {
		return updateNode(f.NewKvsCompactObjectExpression(questionToken, properties, multiLine), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsCompactObjectExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.QuestionToken) || visitNodeList(v, node.Properties)
}

func (node *KvsCompactObjectExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsCompactObjectExpression(node, v.visitNode(node.QuestionToken), v.visitNodes(node.Properties), node.MultiLine)
}

func (node *KvsCompactObjectExpression) Clone(f NodeFactoryCoercible) *Node {
	return cloneNode(f.AsNodeFactory().NewKvsCompactObjectExpression(node.QuestionToken, node.Properties, node.MultiLine), node.AsNode(), f.AsNodeFactory().hooks)
}

func (node *KvsCompactObjectExpression) computeSubtreeFacts() SubtreeFacts {
	return propagateSubtreeFacts(node.QuestionToken) |
		propagateNodeListSubtreeFacts(node.Properties, propagateSubtreeFacts)
}

func IsKvsCompactObjectExpression(node *Node) bool {
	return node.Kind == KindKvsCompactObjectExpression
}
...
type KvsTypedObjectExpression struct {
	PrimaryExpressionBase
	DeclarationBase
	CompositeBase
	Type       *TypeNode
...
func (f *NodeFactory) NewKvsTypedObjectExpression(typeNode *TypeNode, properties *NodeList, multiLine bool) *Node {
	data := &KvsTypedObjectExpression{}
	data.Type = typeNode
	data.Properties = properties
	data.MultiLine = multiLine
	return f.newNode(KindKvsTypedObjectExpression, data)
}

func (f *NodeFactory) UpdateKvsTypedObjectExpression(node *KvsTypedObjectExpression, typeNode *TypeNode, properties *NodeList, multiLine bool) *Node {
	if typeNode != node.Type || properties != node.Properties || multiLine != node.MultiLine {
		return updateNode(f.NewKvsTypedObjectExpression(typeNode, properties, multiLine), node.AsNode(), f.hooks)
	}
	return node.AsNode()
}

func (node *KvsTypedObjectExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.Type) || visitNodeList(v, node.Properties)
}

func (node *KvsTypedObjectExpression) VisitEachChild(v *NodeVisitor) *Node {
	return v.Factory.UpdateKvsTypedObjectExpression(node, v.visitNode(node.Type), v.visitNodes(node.Properties), node.MultiLine)
}

func (node *KvsTypedObjectExpression) Clone(f NodeFactoryCoercible) *Node {
	return cloneNode(f.AsNodeFactory().NewKvsTypedObjectExpression(node.Type, node.Properties, node.MultiLine), node.AsNode(), f.AsNodeFactory().hooks)
}

func (node *KvsTypedObjectExpression) computeSubtreeFacts() SubtreeFacts {
	return propagateSubtreeFacts(node.Type) |
		propagateNodeListSubtreeFacts(node.Properties, propagateSubtreeFacts)
}

func IsKvsTypedObjectExpression(node *Node) bool {
	return node.Kind == KindKvsTypedObjectExpression
}
...
type KvsCollectExpression struct {
	ExpressionBase
	LocalsContainerBase
	CompositeBase
	Initializer *ForInitializer
...
func (node *KvsCollectExpression) ForEachChild(v Visitor) bool {
...
type KvsSelectExpression struct {
	ExpressionBase
	LocalsContainerBase
	CompositeBase
	Initializer *ForInitializer
...
func (node *KvsSelectExpression) ForEachChild(v Visitor) bool {
	return visit(v, node.Initializer) || visit(v, node.Expression) || visit(v, node.Statement)
}
...
func (n *Node) ForEachChild(v Visitor) bool {
	...
	case KindKvsExtantReturnStatement:
		return n.data.(*KvsExtantReturnStatement).ForEachChild(v)
	...
	case KindKvsConditionalElement:
		return n.data.(*KvsConditionalElement).ForEachChild(v)
...
func (n *Node) AsKvsExtantReturnStatement() *KvsExtantReturnStatement {
	return n.data.(*KvsExtantReturnStatement)
}

func (n *Node) AsKvsYieldStatement() *KvsYieldStatement {
	return n.data.(*KvsYieldStatement)
}

func (n *Node) AsKvsExtantYieldStatement() *KvsExtantYieldStatement {
...
func (n *Node) AsKvsExtantAssertionExpression() *KvsExtantAssertionExpression {
	return n.data.(*KvsExtantAssertionExpression)
}
...
func (n *Node) AsKvsSieveExpression() *KvsSieveExpression {
	return n.data.(*KvsSieveExpression)
}
...
func (n *Node) AsKvsConditionalElement() *KvsConditionalElement {
	return n.data.(*KvsConditionalElement)
}

func (n *Node) AsKvsCompactObjectExpression() *KvsCompactObjectExpression {
	return n.data.(*KvsCompactObjectExpression)
}

func (n *Node) AsKvsTypedObjectExpression() *KvsTypedObjectExpression {
